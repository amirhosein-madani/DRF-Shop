...
class ProductSerializer(serializers.ModelSerializer):
    ...
    """
    absolute_url  =serializers.SerializerMethodField()
    color = serializers.SlugRelatedField(slug_field= 'name' ,many = True , queryset= Color.objects.all())
    class Meta:
        model = Product
        fields = ['id','title' , 'description' ,'absolute_url', 'price' , 'color' , 'size' , 'stock'] 
