...
class TestProductApi:
    ...
    def test_create_product_with_normal_user_respomse_403_status(self , api_client , normal_user):
    ...
    def test_create_product_with_amin_user_respomse_400_status(self , api_client , admin_user):
